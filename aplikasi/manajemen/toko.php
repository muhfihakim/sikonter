...
<head>
    ...
    <title>SIKONTER | Pengaturan Toko</title>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                // Query untuk melakukan UPDATE pada tabel toko
                                $query = "UPDATE toko SET nama_toko = '$namaToko', alamat_toko = '$alamatToko' WHERE id = 1";
                            ...
                            ?>
                                ...
                                ?>
                                    <div class="alert alert-danger">
                                        Terjadi Kesalahan Saat Memperbarui Data Toko: <?php echo $koneksi->error; ?>
                                    </div>
                            <?php
                                }
                            }
