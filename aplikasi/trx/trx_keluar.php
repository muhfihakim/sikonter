...
<head>
    ...
    <title>SIKONTER | Transaksi Keluar</title>
            ...
            <section class="content">
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title"><strong>Transaksi Keluar | </strong></h3>
                        <!-- Tombol Cetak -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="modal fade" id="cetakModal" tabindex="-1" role="dialog" aria-labelledby="cetakModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="cetakModalLabel"><i class="fa fa-print"></i><strong> Cetak Transaksi Keluar</strong></h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form id="cetakForm" method="get" action="cetak_trx_keluar.php" target="_blank">
                                            <div class="form-row">
                        ...
                        <div class="table-responsive">
                            <table id="transaksi_keluar_table" class="table table-hover table-bordered">
                                <thead>
                                    <tr>
                            ...
                            <script type="text/javascript">
                                $(document).ready(function() {
                                    $('#transaksi_keluar_table').DataTable({
                                        "ajax": {
                                            "url": "get_trx_keluar.php",
                                            "data": function(d) {
